        ...
        <main class="col-10 ms-sm-auto px-md-4 pt-2 pb-4 main-content">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/nhan-vien/add" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="form-group col-4">
                                <label class="control-label mb-1" for="ma">Mã nhân viên</label>
                                <input class="form-control mb-2" type="text" id="ma" name="ma" required="">
                            </div>
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input class="form-control mb-2" type="text" id="diaChi" name="diaChi" required="">
                            </div>
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input class="form-control mb-2" type="text" id="password" name="password" required="">
                            </div>
